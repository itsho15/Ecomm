...
<aside class="main-sidebar">
  ...
  <li class="treeview {{ active_menu('cities')[0] }}">
    ...
    <ul class="treeview-menu" style="{{ active_menu('cities')[1] }}">
      <li class=""><a href="{{ aurl('cities') }}"><i class="fa fa-building"></i> {{ trans('admin.cities') }}</a></li>
  ...
  <li class="treeview {{ active_menu('departments')[0] }}">
   ...
   <li class="treeview {{ active_menu('manufacturers')[0] }}">
    ...
    <li class="treeview {{ active_menu('shiping')[0] }}">
    <a href="#">
      <i class="fa fa-truck"></i> <span>{{ trans('admin.shiping') }}</span>
      <span class="pull-{{ $angle }}-container">
        <i class="fa fa-angle-{{ $angle }} pull-{{ $angle }}"></i>
      </span>
    </a>
    <ul class="treeview-menu" style="{{ active_menu('shiping')[1] }}">
      <li class=""><a href="{{ aurl('shiping') }}"><i class="fa fa-truck"></i> {{ trans('admin.shiping') }}</a></li>
      <li class=""><a href="{{ aurl('shiping/create') }}"><i class="fa fa-plus"></i> {{ trans('admin.add') }}</a></li>
    </ul>
  </li>

  <li class="treeview {{ active_menu('malls')[0] }}">
    <a href="#">
      <i class="fa fa-shopping-bag"></i> <span>{{ trans('admin.malls') }}</span>
      <span class="pull-{{ $angle }}-container">
        <i class="fa fa-angle-{{ $angle }} pull-{{ $angle }}"></i>
      </span>
    </a>
    <ul class="treeview-menu" style="{{ active_menu('malls')[1] }}">
      <li class=""><a href="{{ aurl('malls') }}"><i class="fa fa-shopping-bag"></i> {{ trans('admin.malls') }}</a></li>
  ...
  <li class="treeview {{ active_menu('weights')[0] }}">
    <a href="#">
      <i class="fa fa-paint-brush"></i> <span>{{ trans('admin.weights') }}</span>
      <span class="pull-{{ $angle }}-container">
        <i class="fa fa-angle-{{ $angle }} pull-{{ $angle }}"></i>
      </span>
    </a>
    <ul class="treeview-menu" style="{{ active_menu('weights')[1] }}">
      <li class=""><a href="{{ aurl('weights') }}"><i class="fa fa-paint-brush"></i> {{ trans('admin.weights') }}</a></li>
